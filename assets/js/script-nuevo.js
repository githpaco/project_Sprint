      ...
      // htmlCode2, cssCode2 EL NUMERO FINAL INDICA EL SECTION DONDE SE INTRODUCIRA EL CÓDIGO
        document.getElementById("htmlCode22").value = "<h2 class='mi-titulo'>Este es mi título </h2>";
        document.getElementById("cssCode22").value = 
      ...
      //  FIN INTRODUCCIÓN DEL CODIGO CSS Y HTML POR DEFECTO
		...
		document.getElementById("htmlCode22").addEventListener("input", () => updatePreview(22));
        document.getElementById("cssCode22").addEventListener("input", () => updatePreview(22));
